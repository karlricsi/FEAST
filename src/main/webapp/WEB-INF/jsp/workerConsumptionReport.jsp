		...
		<annalog:application>
			<annalog:view>
				...
				<header>
					...
					<h2>Dolgozói fogyastás riport: <span data-model='month'></span></h2>
				</header>
				<nav>
					<fieldset>
				...
				<main>
					<div id='table'>
						<div class='row'>
							<div class='cell'><b>Dolgozó</b></div>
			...
			<annalog:view name='consumption'>
				<div class='row'>
					...
					<div class='cell'><span data-model='consumptions' data-number='%model.counter' data-element='consumption'></span>.-</div>
				</div>
			</annalog:view>
		</annalog:application>
	</body>
